...
Static Function MenuDef()
    ...
    ADD OPTION aRotina TITLE 'Recursos Aninhados'    ACTION 'u_callSV'        OPERATION 8 ACCESS 0
    ADD OPTION aRotina TITLE 'Relatório Aninhado'    ACTION 'u_callRep'       OPERATION 8 ACCESS 0
Return aRotina
...
*/
//-------------------------------------------------------------------
user function callRep()
local oSmartView as object

oSmartView := totvs.framework.smartview.callSmartView():new("UNIVERSO.SV.OBJETO.ANINHADO.PADRAO.REP", "report")
...
//-------------------------------------------------------------------
/*{Protheus.doc} callGrid
Chama a visão do Smart View
...
oSmartView := totvs.framework.smartview.callSmartView():new("UNIVERSO.SV.OBJETO.ANINHADO")
oSmartView:executeSmartView()
